...
export const initialAgenda = [
  {
    ...
    classRoom: "أ",
    subject: "الرياضيات",
    title: "درس حل معادلات الدرجة الأولى بمتغير واحد ص 45",
    titleEn: "Linear Equations Lesson p. 45",
    homework: "شرح تفصيلي لخطوات حل المعادلات الخطية. الواجب المطلوب: حل التمارين من 1 إلى 5 في كراس الأنشطة ص 46 والتأكد من التحقق من صحة الإجابة.",
    homeworkEn: "Solve linear equations p. 45. Homework: Exercises 1-5 on page 46.",
  ...
  },
  {
    ...
    title: "📌 درس تركيب الخلية الحية وتجارب المجهر العملي",
    titleEn: "Living Cell Structure & Microscope Lab",
    homework: "دراسة النواة والسيتوبلازم والغشاء الخلوي تحت المجهر. الواجب: رسم مجسم توضيحي للخلية النباتية وكتابة أسماء الأجزاء الأربعة الرئيسية.",
    homeworkEn: "Study plant cell under microscope. Draw diagram with 4 main parts labeled.",
    activityType: "lesson"
  },
  {
    id: "AGN-103",
    ...
    titleEn: "English Grammar: Present Perfect vs Past Simple",
    homework: "Complete Exercises A & B on page 34 in Workbook. Write 5 custom sentences using (have/has + V3) to present in tomorrow's class.",
    homeworkEn: "Complete Exercises A & B on page 34 in Workbook.",
    activityType: "homework"
  },
  {
    id: "AGN-104",
    ...
    title: "💻 بناء أول برنامج بلغة Python واستخدام المتغيرات",
    titleEn: "Building First Python Program with Variables",
    homework: "كتابة برنامج كود بايثون بسيط يطلب اسم المستخدم وعمره ويطبع رسالة ترحيبية مخصصة. تسليم الكود عبر رابط المنظومة الذكية.",
    homeworkEn: "Write a python script taking user name & age. Submit code via portal.",
    activityType: "homework"
  },
  {
    id: "AGN-105",
    ...
    title: "قواعد إعراب الجملة الاسمية والهمزة المتوسطة",
    titleEn: "Arabic Grammar & Hamza Rules",
    homework: "أعرب الجمل الآتية إعراباً تاماً: (العلمُ نورٌ - يقرأُ الطالبُ الكتابَ بحرصٍ). مع حفظ 5 كلمات تطبيقية على قواعد كتابة الهمزة المتوسطة.",
    homeworkEn: "Analyze Arabic sentences & learn Hamza writing rules.",
    activityType: "lesson"
  },
  {
    id: "AGN-106",
    ...
    title: "🕌 تلاوة وحفظ سورة الملك (الآيات 1-10) وأحكام الإظهار",
    titleEn: "Surah Al-Mulk Recitation & Tajweed",
    homework: "الاستماع للتلاوة العطرة وحفظ الآيات الكريمة 1-10 مع تطبيق أحكام الإظهار الشفهي وحروف الإظهار الستة.",
    homeworkEn: "Memorize Surah Al-Mulk verses 1-10 with Tajweed rules.",
    activityType: "homework"
  }
];
